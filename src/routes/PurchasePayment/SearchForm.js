...
function SearchForm({
  ...
  const collapseFormItemsConfig = [
    ...
    [{
      ...
      id: 'payType',
      formCol: { ...collapseFormCol },
      data: util.jsonToSelectOptions(allFundsPayment),
    }, {
      label: '请款人',
      type: 'text',
      id: 'requester',
...
function mapStateToProps({ common, purchasePayment }) {
  const { loading, selectedRowsArr, exportInputs } = purchasePayment;

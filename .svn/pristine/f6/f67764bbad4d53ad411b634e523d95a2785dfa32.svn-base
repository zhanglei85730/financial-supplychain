...
export default {
  ...
  // FBA调拨
  domainFbaWarehouseAllotLedger: 'http://192.168.25.234:9099',
  // 销毁报表
  domainDestroyReport: 'http://192.168.25.68:9299',
  // 跨法人调拨
  // domainCorporateTransfer: 'http://legal-allot.aukeyit.com',
  domainCorporateTransfer: 'http://192.168.25.69:9095',
  // 亚马逊盘点
  domainAmazonInventory: 'http://192.168.25.236:9099',
  // 调拨单据
  // domainTransferReceiptInternal: 'http://192.168.25.70:9095',
  domainTransferReceiptInternal: 'http://legal-allot.aukeyit.com',

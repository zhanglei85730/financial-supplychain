...
class DataTable extends React.Component {
  ...
  columns = [{
    ...
    render: (value, row, index) => {
      return this.renderHandel(value, row, index, 'businessType');
    },
  },
  {
    title: '金蝶业务类型',
    dataIndex: 'kisBusinessType',
    key: 'kisBusinessType',
    ...this.tdWidth,
    render: (value, row, index) => {
      return this.renderHandel(value, row, index, 'kisBusinessType');
    },
  },
  {
    title: '金蝶业务类型编码',
    dataIndex: 'kisBusinessCode',
    key: 'kisBusinessCode',
    ...this.tdWidth,
    render: (value, row, index) => {
      return this.renderHandel(value, row, index, 'kisBusinessCode');
    },
  }, {
    title: '创建人',
    dataIndex: 'creator',
...
function mapStateToProps({ businessTypeMaintenance }) {
  return businessTypeMaintenance;
}
